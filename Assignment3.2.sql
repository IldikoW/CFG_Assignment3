/*
I want to help a friend who has a dog walking business to store her clients and jobs. To do 
this I have created the following tables : clients or the names,contacts  for contact details, dogs for the dogs names and breed . 
More than one owner can can more than one dogs so it is a many to many realtionship so I created a table to join dogs and owners 
called dogs_owners. There is another table called jobs contains the dog walking jobs with date, start and finish of the walks.
The coloumn time is calculated with start and finsih time and shows how long the walk was. The coloumn total show the total price of the walk = time x £12 
*/
